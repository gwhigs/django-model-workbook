"""
Fix pulled from https://gist.github.com/psjinx/d8c9c548a5a761be7ae6 for
 applying an outer border to a range of cells. Minimal changes from original.

See also: https://github.com/jmcnamara/XlsxWriter/issues/111
...
def excel_range_string_to_indices(range_string):
    ...
    first_col_index = col_to_num(first_col_name) - 1
    first_row_index = int(first_row) - 1
    last_col_index = col_to_num(last_col_name) - 1
